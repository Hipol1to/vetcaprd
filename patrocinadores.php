...
<section class="custom-partners-section">
    <h2 class="custom-partners-title">PATROCINADORES</h2>
    <p class="custom-partners-description">
        Estamos orgullosos de contar con una lista diversa de empresas nacionales e internacionales como parte de Vetcap.
        Trabajamos en estrecha colaboración con nuestros socios comerciales para brindar la mejor experiencia de educación
        y entretenimiento veterinario del país para todos. Implementamos una amplia gama de ideas y soluciones creativas
        durante las activaciones de patrocinadores que comparten la visión, el tono y el compromiso de convertirlo en un
        mejor veterinario.
    </p>
    <button class="custom-sponsor-button">VUELVETE SPONSOR</button>
