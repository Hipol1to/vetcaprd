                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        if (count($image_paths) === 2) {
                            ...
                            echo '<img src="http://localhost/vescaprod/' . htmlspecialchars($image_paths[0]) . '" alt="Captura frontal no disponible" class="img-thumbnail" style="max-width: 100%;">';
                            echo '</div>';
                            echo '<div class="col-md-6">';
                            echo '<p>Captura Posterior</p>';
                            echo '<img src="http://localhost/vescaprod/' . htmlspecialchars($image_paths[1]) . '" alt="Captura posterior no disponible" class="img-thumbnail" style="max-width: 100%;">';
                            echo '</div>';
                            echo '</div>';
                        } else {
