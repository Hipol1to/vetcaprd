                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        if (count($image_paths) === 2) {
                            ...
                            echo '<img src="http://localhost/vesca/' . htmlspecialchars($image_paths[0]) . '" alt="Captura Frontal" class="img-thumbnail" style="max-width: 100%;">';
                            echo '</div>';
                            echo '<div class="col-md-6">';
                            echo '<p>Captura Posterior</p>';
                            echo '<img src="http://localhost/vesca/' . htmlspecialchars($image_paths[1]) . '" alt="Captura Posterior" class="img-thumbnail" style="max-width: 100%;">';
                            echo '</div>';
                            echo '</div>';
                        } else {
