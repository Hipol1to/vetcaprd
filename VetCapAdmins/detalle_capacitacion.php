            ...
            <div class="tab-pane fade show active" id="details">
                <form method="POST" action="actualizar_capacitacion.php">
                    ...
                    <div class="form-group">
                        ...
                        <img src="http://localhost/vesca/<?= htmlspecialchars(str_replace("../", "", $capacitacion['foto_diplomado'])) ?>" alt="Foto del Diplomado no disponible" class="img-thumbnail mt-2" style="max-width: 200px;" id="foto_diplomado_preview">
                    </div>
                    <div class="form-group">
